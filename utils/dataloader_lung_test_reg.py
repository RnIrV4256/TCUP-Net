...
class DatasetFromFolder3D(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        labed_img1 = (labed_img1 - np.min(labed_img1)) / (np.max(labed_img1) - np.min(labed_img1))
        labed_img1 = labed_img1.astype(np.float32)
        labed_img1 = labed_img1[np.newaxis, :, :, :]
        labed_img1 = labed_img1[..., 2:82]
        ...
        labed_lab1 = np.tile(labed_lab1, (2, 1, 1)) / 255.
        labed_lab1 = labed_lab1[..., 2:82]
        ...
        labed_img2 = (labed_img2 - np.min(labed_img2)) / (np.max(labed_img2) - np.min(labed_img2))
        labed_img2 = labed_img2.astype(np.float32)
        labed_img2 = labed_img2[np.newaxis, :, :, :]
        labed_img2 = labed_img2[..., 2:82]
        ...
        labed_lab2 = np.tile(labed_lab2, (2, 1, 1)) / 255.
        labed_lab2 = labed_lab2[..., 2:82]
